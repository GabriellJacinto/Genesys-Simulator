...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DialogModelInformation_t, stringdata0) + ofs), len 
...
const QMetaObject DialogModelInformation::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DialogModelInformation.offsetsAndSize,
