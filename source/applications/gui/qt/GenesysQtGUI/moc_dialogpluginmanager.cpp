...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DialogPluginManager_t, stringdata0) + ofs), len 
...
const QMetaObject DialogPluginManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DialogPluginManager.offsetsAndSize,
