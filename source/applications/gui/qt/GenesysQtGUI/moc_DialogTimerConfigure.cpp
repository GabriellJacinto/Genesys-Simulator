...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DialogTimerConfigure_t, stringdata0) + ofs), len 
...
const QMetaObject DialogTimerConfigure::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DialogTimerConfigure.offsetsAndSize,
