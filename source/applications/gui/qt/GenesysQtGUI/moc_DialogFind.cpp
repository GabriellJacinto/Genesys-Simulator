...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FindLineEdit_t, stringdata0) + ofs), len 
...
const QMetaObject FindLineEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_FindLineEdit.offsetsAndSize,
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DialogFind_t, stringdata0) + ofs), len 
...
const QMetaObject DialogFind::staticMetaObject = { {
    ...
    qt_meta_stringdata_DialogFind.offsetsAndSize,
