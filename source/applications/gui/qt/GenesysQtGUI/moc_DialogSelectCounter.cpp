...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DialogSelectCounter_t, stringdata0) + ofs), len 
...
const QMetaObject DialogSelectCounter::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DialogSelectCounter.offsetsAndSize,
