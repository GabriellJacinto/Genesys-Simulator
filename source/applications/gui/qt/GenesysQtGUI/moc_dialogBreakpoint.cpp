...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_dialogBreakpoint_t, stringdata0) + ofs), len 
...
const QMetaObject dialogBreakpoint::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_dialogBreakpoint.offsetsAndSize,
